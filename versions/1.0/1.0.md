...
| <a name="constructionObjectRoughOpening"></a>roughOpening 	| `??????` 	  | Проем в заказе                                                           	|
| <a name="constructionObjectElements"></a>elements         	| `array`  	  | Список элементов (products, components etc.) в конструкции, ex products. 	|
| <a name="constructionObjectConnections"></a>connections   	| `array`  	  | Список соединителей элементов конструкции                                	|
...
| <a name="connectionObjectGeometry"></a>geometry 	          | `??????` 	  | ????                                                          	          |
| <a name="connectionObjectProfile"></a>profile         	    | `??????`  	| **REQUIRED** 	                                                          |
| <a name="connectionObjectCutting"></a>cutting   	          | `??????`  	| ????                               	                                      |
...
| <a name="elementObjectProfileSystem"></a>profileSystem      | `??????`  	| ????                                                                      |
| <a name="elementObjectGeometry"></a>geometry  	            | `array`  	  | **REQUIRED**   ????                               	                                      |
| <a name="elementObjectSplitters"></a>splitters   	          | `array`  	  | ex segments                               	                              |
| <a name="elementObjectComponents"></a>components   	        | `array`  	  | ????                               	                                      |
