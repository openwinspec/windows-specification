...
| Field                                                     	| Type     	  | Description                                                              	|
|-----------------------------------------------------------	|:----------:	|--------------------------------------------------------------------------	|
| <a name="componentObjectComponentType"></a>componentType    | `??????` 	  | ex element_type                                     	                |
| <a name="componentObjectFeature"></a>features	              | `??????` 	  | Тип элемента                                                       	      |
| <a name="componentObjectGeometryId"></a>geometryId          | `??????`  	| ex poligon_id                                                         |
| <a name="componentObjectSplitterId"></a>splitterId  	      | `??????`  	| ссылка на геометрию сплиттера, как это объединить с geometryId ?          |
| <a name="componentObjectProfile"></a>profile   	            | `??????`  	| если применяется для всех балок компонента                               	|
| <a name="componentObjectBeams"></a>beams   	                | `array`  	  | ex profile_polygon                               	                    |
| <a name="componentObjectComponents"></a>components   	      | `array`  	  | ex product_elements                               	                  |
...
| Field                                                     	| Type     	  | Description                                                              	|
|-----------------------------------------------------------	|:----------:	|--------------------------------------------------------------------------	|
| <a name="beamObjectProfile"></a>profile    | `object ???` 	  |                                    	                |
| <a name="beamObjectCutting"></a>cutting	              | `??????` 	  |                                                    	      |
...
| Field                                                     	| Type     	  | Description                                                              	|
|-----------------------------------------------------------	|:----------:	|--------------------------------------------------------------------------	|
| <a name="beamCuttingObjectStartExt"></a>start_ext    | `object ???` 	  |                                    	                |
| <a name="beamCuttingObjectStartInt"></a>start_int	              | `??????` 	  |                                                    	      |
| <a name="beamCuttingObjectEndExt"></a>end_ext          | `string`  	|                                                         |
| <a name="beamCuttingObjectEndInt"></a>end_int  	      | `boolean`  	|           |

&nbsp;

----------------------------------

### <a name="glazingBeadFeatureObject"></a>Cutting Type 
...
| Field                                                     	| Type     	  | Description                                                              	|
|-----------------------------------------------------------	|:----------:	|--------------------------------------------------------------------------	|
| <a name="fillingFeatureObjectSize"></a>size    | `number` 	  |                                    	                |
| <a name="fillingFeatureObjectType"></a>fillingType	              | `??????` 	  |                                                    	      |
| <a name="fillingFeatureObjectFeatures"></a>features          | `string`  	|                                                         |
| <a name="fillingFeatureObjectGlazingBeads"></a>glazingBeads  	      | `array`  	|           |
...
| Field                                                     	| Type     	  | Description                                                              	|
|-----------------------------------------------------------	|:----------:	|--------------------------------------------------------------------------	|
| <a name="fillingTypeFeatureObjectGlazingFeature"></a>glazingFeature    | `?????` 	  |                                    	                |
| <a name="fillingTypeFeatureObjectPanelFeature"></a>panelFeature	              | `??????` 	  |                                                    	      |
| <a name="fillingTypeFeatureObjectVirtualFeature"></a>virtualFeature          | `?????`  	|                                                         |
| <a name="fillingTypeFeatureObjectOneOf"></a>ONE OF REQUIRED  	      | `[glazingFeature, panelFeature, virtualFeature]`  	|           |
